(function($) {
   ...
   function naylaHeader() {
       ...
       function dynamicHeader() {
           var fixedStart, allInstances = ScrollTrigger.getAll();
           allInstances.forEach(function(st) {
               if ((st.pin != null) && (st.start <= 0)) {
   ...
   function showcaseImageLeave(tl, media) {
       ...
       if (media.find('.n-vimeo').length || media.find('.n-youtube').length) {} else {
           gsap.set(media, {
               top: medTop,
               width: wido,
               height: height,
       ...
       transitions: [{
           ...
           leave() {
               return new Promise(function(resolve, reject) {
                   ...
                   if ($('div.showcase-carousel').length || $('div.showcase-fullscreen-carousel').length || $('div.showcase-fullscreen-slideshow').length || $('div.showcase-3d-titles').length || $('div.showcase-cards').length) {} else {
                   ...
                   if (matches) {
                       matches.forEach(function(match) {
                           ...
                           if (valueMatch && valueMatch[1]) {
                               var value = valueMatch[1].replace(/\s*!important/g, '');
   ...
   barba.hooks.enter((data) => {
       ...
       var headTags = ['meta[name="keywords"]', 'meta[name="description"]', 'meta[property^="og"]', 'meta[name^="twitter"]', 'meta[itemprop]', 'link[itemprop]', 'link[rel="prev"]', 'link[rel="next"]', 'link[rel="canonical"]', 'link[rel="alternate"]', 'link[rel="shortlink"]', 'link[id*="google-fonts"]', 'style[id*="nayla-body-styles"]'].join(',');
       $(response).remove();
